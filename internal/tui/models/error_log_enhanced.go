...
type ErrorLogEnhancedModel struct {
...
func (m ErrorLogEnhancedModel) Init() tea.Cmd {
	return tea.Batch(
		m.refreshLogs(),
...
func (m ErrorLogEnhancedModel) Update(msg tea.Msg) (tea.Model, tea.Cmd) {
	var cmd tea.Cmd
	var cmds []tea.Cmd
...
func (m ErrorLogEnhancedModel) View() string {
	if m.searchMode == SearchModeActive {
...
func (m *ErrorLogEnhancedModel) updateViewport() {
	if len(m.filteredEntries) == 0 {
...
func (m *ErrorLogEnhancedModel) scrollToSelected() {
...
func (m ErrorLogEnhancedModel) renderLogLevel(level string) string {
...
func (m ErrorLogEnhancedModel) renderLogDetails(entry LogEntry) string {
	if !m.showDetails {
		return ""
	}
...
func (m *ErrorLogEnhancedModel) cycleFilter() tea.Cmd {
	return func() tea.Msg {
...
func (m ErrorLogEnhancedModel) exportLogs() tea.Cmd {
	return func() tea.Msg {
...
func (m ErrorLogEnhancedModel) refreshLogs() tea.Cmd {
	return func() tea.Msg {
...
func (m ErrorLogEnhancedModel) clearLogs() tea.Cmd {
	return func() tea.Msg {
		err := m.clearLogFile()
		if err != nil {
...
func (m ErrorLogEnhancedModel) loadLogsFromFile() ([]LogEntry, error) {
...
func (m ErrorLogEnhancedModel) parseLogLine(line string) (LogEntry, error) {
...
func (m ErrorLogEnhancedModel) clearLogFile() error {
	logFile := utils.GetLogFilePath()
